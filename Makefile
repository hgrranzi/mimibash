...
SRCS = main.c mimibash.c init.c handle_signal.c exec_cmd.c builtins.c print_sorted_env.c arr.c wildcard.c \
		...
		parser.c remove_n.c check_builtins.c pipesplit.c shielding.c shielding_utils.c redir_utils.c parse_star.c
